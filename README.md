...
## Division of Work
* Gabriel and Arther will concentrate on implementing the USRP localization logic.
* Jinchi will focus on developing the AR application.
