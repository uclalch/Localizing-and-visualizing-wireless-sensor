...
# Title: Top Block
# Generated: Mon Dec  9 14:28:59 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.usrp_1 = usrp_1 = "serial=3186907"
        self.usrp_0 = usrp_0 = "serial=318F197"
        self.signal_freq = signal_freq = 1e5
        self.samp_rate = samp_rate = 32e6
        self.low_pass_gain = low_pass_gain = 1e3
        ...
        self.uhd_usrp_source_0_0.set_bandwidth(samp_rate/2, 0)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	low_pass_gain, samp_rate, 1.2*signal_freq, 1e5, firdes.WIN_HAMMING, 6.76))
        self.diffApp_dTime_0 = diffApp.dTime()
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_complex_to_real_0_0 = blocks.complex_to_real(1)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, signal_freq, 1, 0)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.diffApp_dTime_0, 0))
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_float_to_complex_0, 1))
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.diffApp_dTime_0, 1))
        ...
        self.connect((self.diffApp_dTime_0, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.diffApp_dTime_0, 1), (self.qtgui_number_sink_1, 0))
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.low_pass_filter_0_0, 0))
    ...
    def set_usrp_1(self, usrp_1):
        self.usrp_1 = usrp_1

    def get_usrp_0(self):
        return self.usrp_0

    def set_usrp_0(self, usrp_0):
        self.usrp_0 = usrp_0
    ...
    def set_signal_freq(self, signal_freq):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(self.low_pass_gain, self.samp_rate, 1.2*self.signal_freq, 1e5, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.uhd_usrp_source_0_0.set_bandwidth(self.samp_rate/2, 0)
        self.uhd_usrp_source_0_0.set_bandwidth(self.samp_rate/2, 1)
